        ...
        <div class="col s12 m6"> -->
            <div class="card" style="padding: 0%; width: 30%; height: 40%; padding-top: 5%; padding-bottom: 5%">
                ...
                <div class="card-content" style="width: 100%">
                    ...
                    <a class="btn-floating halfway-fab waves-effect waves-light red" @click="submit"><input type='submit' @click="submit" value="" hidden><i class="material-icons" @click="submit">add</i></a>
                </div>
            </div>
        <!-- </div>
    </div> -->
